...
if (‘serviceWorker’ in navigator) {
 window.addEventListener(‘load’, function() {  
  ...
  // Находим тег <li>, которому нужно добавить класс active
  	var liElement = document.getElementById('deserts'); // замените 'yourLiId' на id вашего тега <li>
...
<?php include 'assets/piece/katalog_deserts.php'; ?>
